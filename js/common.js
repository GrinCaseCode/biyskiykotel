$(document).ready(function () {
	...
	$(".sandwich").click(function () {
		if (!$(".header__content").hasClass("active")) {
...

	{
		if ($(window).width() > 992) {
			...
			$(".catalog-dropdown__haschild").on("mouseenter", function () {
...

	{
		if ($(window).width() < 992) {
			$(".close-dropdown").click(function () {
				...
				$(this).parent().siblings().find(".close-dropdown").removeClass("active");
			...
			$(".btn-wrap .btn-main").click(function (e) {
				e.preventDefault();
				$(".btn-popup").slideToggle(200);
			});

			$(document).mouseup(function (e) {
				var container2 = $(".btn-wrap");
				if (container2.has(e.target).length === 0) {
					$(".btn-popup").slideUp(200);
				}
			});
